...
This documentation describes BackupPC version 4.0.0alpha1,
released on 30 Jun 2013.
...
BackupPC-4.0.0alpha1.tar.gz, run these commands as root:

    tar zxf BackupPC-4.0.0alpha1.tar.gz
...
available, eg: BackupPC-4.0.0alpha1pl2.diff, you should apply
the patch after extracting the tar file:

     # fetch BackupPC-4.0.0alpha1.tar.gz
     # fetch BackupPC-4.0.0alpha1pl2.diff
     tar zxf BackupPC-4.0.0alpha1.tar.gz
     cd BackupPC-4.0.0alpha1
     patch -p0 < ../BackupPC-4.0.0alpha1pl2.diff
     perl configure.pl
