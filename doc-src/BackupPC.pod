...
See for example L<http://blogs.msdn.com/adioltean/archive/2005/01/05/346793.aspx>
...
L<Step 3: Setting up config.pl|"Step 3: Setting up config">, there are four ways to tell 
